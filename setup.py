...
def configuration(parent_package = "", top_path = None):
  ...
  CONFIG.add_scripts(os.path.join("bin", "testPyCerebralPlot"))
...
exec(open('PyCerebralPlots/version.py').read())
setup(name = PACKAGE_NAME, version = __version__, include_package_data=True,
  ...
  description="PyCerebralPlots",
  long_description="",
  url="https://github.com/trislett/PyCerebralPlots.git",
  download_url="",
  ...
  package_data={'PyCerebralPlots': ['static/*']},
